  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto min-h-0 flex flex-col">
        {activeTab === "messages" && (
          <div className="flex-1 overflow-y-auto p-5 flex flex-col custom-scrollbar min-h-0 border-b-0">
            <div className="mt-auto flex flex-col gap-3">
              {/* Step Header & Pagination Block */}
              <div className="mb-3 pb-3 border-b border-gray-200">
                {/* Row 1: Text Section */}
                <div className="mb-2">
                  <h3 className="text-sm font-bold text-gray-900">
                    Step {prospect.stepNumber} of {prospect.step} · Prospect {activeProspectIndex + 1} of {PRIORITY_PROSPECTS.length}
                  </h3>
                </div>
                {/* Row 2: Actions Section */}
                <div className="flex gap-2">
                  <button
                    type="button"
                    onClick={handlePrevious}
                    disabled={isFirstProspect}
                    className="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 text-xs font-medium py-1 px-2.5 rounded disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    &lt; Previous
                  </button>
                  <button
              ...
              {/* Message Container - Slack Native Layout */}
              <div className="flex items-start gap-3 w-full">
                {/* Avatar Column */}
                <div className="flex-shrink-0">
                  <Image src="/slackbot-logo.svg" alt="Slackbot" width={36} height={36} className="w-9 h-9 rounded" />
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="font-bold text-gray-900">Slackbot</span>
                    <span className="text-xs text-gray-500 font-normal">Just now</span>
                  </div>

                  {/* Message Body */}
                  <div className="flex flex-col gap-4">
                    {/* Prospect Identity Block */}
                    <ProspectIdentityBlock prospect={prospect} priority={activeProspectIndex === 0 ? "hot" : "warm"} />
                    ...
                    {/* Email Composer */}
                    <div>
                      {/* Draft Email Header with Tooling */}
